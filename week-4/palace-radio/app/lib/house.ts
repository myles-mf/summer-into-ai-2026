...
export const HOUSE_PROPS: HouseProp[] = [
  ...
  { id: 'lamp', model: 'lampRoundFloor.glb', position: [-2.2, -2.6], rotationY: 0, collisionRadius: 0 },
  ...
  { id: 'deskLamp', model: 'lampSquareTable.glb', position: [3.6, -2.9], rotationY: 0, collisionRadius: 0 },
